...
class MovieMaker:
    ...
    def __init__(self, img_seq, movie_name, movie_format='.mp4', framerate=60):
    ...
    def make_movie(self):
        cmd = f'ffmpeg -r {self.framerate} -f image2 -s 1920x1080 -i "{self.input_imgSequence_path}" -vcodec libx264 -crf 20 -pix_fmt yuv420p "{self.output_file_path}"'
